...
func TestEvaluator_FiveCardEvaluationRoyalFlush(t *testing.T) {
	...
	board := []Card{
		...
		func() Card { c, _ := NewCard("Ks"); return c }(),
		func() Card { c, _ := NewCard("Qs"); return c }(),
		func() Card { c, _ := NewCard("Js"); return c }(),
		func() Card { c, _ := NewCard("Ts"); return c }(),
	}
	handRank := e.Evaluate([]Card{}, board)
	if handRank != 1 {
...
func TestEvaluator_FiveCardEvaluationFourOfAKind(t *testing.T) {
	...
	board := []Card{
		...
		func() Card { c, _ := NewCard("Ad"); return c }(),
		func() Card { c, _ := NewCard("Ah"); return c }(),
...
func TestEvaluator_FiveCardEvaluationFullHouse(t *testing.T) {
	...
	board := []Card{
		...
		func() Card { c, _ := NewCard("Kd"); return c }(),
		func() Card { c, _ := NewCard("2s"); return c }(),
		func() Card { c, _ := NewCard("2c"); return c }(),
	}
	handRank := e.Evaluate([]Card{}, board)
	if handRank != 190 {
...
func TestEvaluator_FiveCardEvaluationFlush(t *testing.T) {
	...
	board := []Card{
		func() Card { c, _ := NewCard("As"); return c }(),
		func() Card { c, _ := NewCard("Ks"); return c }(),
		func() Card { c, _ := NewCard("8s"); return c }(),
		func() Card { c, _ := NewCard("5s"); return c }(),
		func() Card { c, _ := NewCard("2s"); return c }(),
	}
	handRank := e.Evaluate([]Card{}, board)
	if handRank != 463 {
...
func TestEvaluator_FiveCardEvaluationStraight(t *testing.T) {
	...
	board := []Card{
		func() Card { c, _ := NewCard("As"); return c }(),
		func() Card { c, _ := NewCard("Kc"); return c }(),
		func() Card { c, _ := NewCard("Qd"); return c }(),
		func() Card { c, _ := NewCard("Jh"); return c }(),
		func() Card { c, _ := NewCard("Ts"); return c }(),
	}
	handRank := e.Evaluate([]Card{}, board)
	if handRank != 1600 {
...
func TestEvaluator_FiveCardEvaluationThreeOfAKind(t *testing.T) {
	...
	board := []Card{
		...
		func() Card { c, _ := NewCard("Ac"); return c }(),
		func() Card { c, _ := NewCard("Ad"); return c }(),
		func() Card { c, _ := NewCard("5h"); return c }(),
		func() Card { c, _ := NewCard("2s"); return c }(),
	}
	handRank := e.Evaluate([]Card{}, board)
	if handRank != 1672 {
...
func TestEvaluator_FiveCardEvaluationTwoPair(t *testing.T) {
	...
	board := []Card{
		...
		func() Card { c, _ := NewCard("Ks"); return c }(),
		func() Card { c, _ := NewCard("Kc"); return c }(),
		func() Card { c, _ := NewCard("2d"); return c }(),
	}
	handRank := e.Evaluate([]Card{}, board)
	if handRank != 2478 {
...
func TestEvaluator_FiveCardEvaluationHighCard(t *testing.T) {
	...
	board := []Card{
		func() Card { c, _ := NewCard("As"); return c }(),
		func() Card { c, _ := NewCard("Kd"); return c }(),
		func() Card { c, _ := NewCard("Qc"); return c }(),
		func() Card { c, _ := NewCard("Jh"); return c }(),
		func() Card { c, _ := NewCard("9s"); return c }(),
	}
	handRank := e.Evaluate([]Card{}, board)
	if handRank != 6186 {
...
func TestEvaluator_SevenCardEvaluation(t *testing.T) {
	...
	board := []Card{
		...
		func() Card { c, _ := NewCard("Ts"); return c }(),
		func() Card { c, _ := NewCard("2c"); return c }(),
		func() Card { c, _ := NewCard("3d"); return c }(),
	}
	handRank := e.Evaluate(hand, board)
	if handRank != 1 {
...
func TestEvaluator_GetFiveCardRankPercentage(t *testing.T) {
	...
	// Worst hand
	if percentage := e.GetFiveCardRankPercentage(7462); percentage != 7462.0/7462.0 {
		t.Errorf("Worst hand percentage = %f, want %f", percentage, 7462.0/7462.0)
	}
}